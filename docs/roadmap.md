...
## 📡 Phase 5 — Portability & Retention *(complaint #9 / market gap)*
...
- [x] **Multi-PDF episodes** ✅ SHIPPED 2026-07-31 — upload up to 5 PDFs; `readUploads()` extracts + concatenates them with labeled sections; combined text stored (`saveSourceText`), credit cost from combined length. Multi-file upload UI with "+N more" labels. Verified in prod: 2 files → ~2× chars, 6 files → 400.
